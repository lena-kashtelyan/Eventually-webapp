...
public class DatabaseFactory {
	...
	public void createAndIndexTables() {
		try {
			createUsersTable();
	...
	private void createGoingTable() throws SQLException {
		try (Connection conn = db.getConnection()) {
			...
			String schema = "CREATE TABLE GOING(" + 
	...
	private void createExternalTable() throws SQLException {
		try (Connection conn = db.getConnection()) {
			...
			String schema = "CREATE TABLE EXTERNAL(" +
							"userID TEXT NOT NULL," + 
	...
	private void createVisualMediaTable() throws SQLException {
		try (Connection conn = db.getConnection()) {
			...
			String schema = "CREATE TABLE VISUAL_MEDIA(" +
	...
	private void createVenueTable() throws SQLException {
		try (Connection conn = db.getConnection()) {
			...
			String schema = "CREATE TABLE VENUE(" + 
							"venueID TEXT NOT NULL," +
							"name TEXT NOT NULL," +
	...
	private void createInvitedTable() throws SQLException {
		try (Connection conn = db.getConnection()) {
			...
			String schema = "CREATE TABLE INVITED(" +
							"eventID TEXT NOT NULL," +
							"userID TEXT NOT NULL," + 
							"FOREIGN KEY(userID) REFERENCES USERS(userID)," +
							"FOREIGN KEY(eventID) REFERENCES EVENTS(eventID));";
	...
	private void createInterestedTable() throws SQLException {
		try (Connection conn = db.getConnection()) {
			...
			String schema = "CREATE TABLE INTERESTED(" + 
							"eventID TEXT NOT NULL," +
							"userID TEXT NOT NULL," + 
							"FOREIGN KEY(userID) REFERENCES USERS(userID)," +
							"FOREIGN KEY(eventID) REFERENCES EVENTS(eventID));";
	...
	private void createNonUsersTable() throws SQLException {
		try (Connection conn = db.getConnection()) {
			...
			String schema = "CREATE TABLE NONUSERS(" + 
