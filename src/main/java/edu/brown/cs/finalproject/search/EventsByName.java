...
/*
 * Fetches public Facebook events by name (for Machine
 * Learning training)
 */
public class EventsByName {
  ...
  public EventsByName() {
    ...
    FacebookClient facebookClient23 = new DefaultFacebookClient(
    ...
    Connection<Event> eventList = facebookClient23.fetchConnection("search",
        Event.class, Parameter.with("q", "party"),
        Parameter.with("type", "event"), Parameter.with("limit", 1000));
