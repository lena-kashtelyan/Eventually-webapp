...
public class MapsSparkServer implements SparkServer {
  ...
  public void runSparkServer() {
    ...
    Spark.get("/browse", new BrowseView(), freeMarker);
    ...
    Spark.get("/facebooklogin", new FacebookLoginView());
    Spark.get("/fbr", new FacebookLoginResponse());
    Spark.get("/event", new EventView("event.ftl"), freeMarker);
    Spark.post("/attend", new AttendHandler());
    Spark.post("/unattend", new UnattendHandler());
    ...
    Spark.post("/media", new MediaHandler());
    Spark.get("/my", new MyEventsView("myevents.ftl"), freeMarker);
