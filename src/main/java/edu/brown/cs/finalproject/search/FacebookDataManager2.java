...
public class FacebookDataManager2 {
  ...
  public FacebookDataManager2() throws IOException {
    ...
    try {
      Thread.sleep(8000); // 1000 milliseconds is one
                          // second.
   ...
   */
  public synchronized void requestPublicEvents(double latitude,
  ...
  public static JsonObject queryEvents(double latitude, double longitude,
    ...
    urlBuilder.append(
        "&sort=time&access_token=220099498366885|8a0e23ef1bc9e94213c881e53b2d7343");
